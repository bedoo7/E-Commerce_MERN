		...
		const products = [
			{
				...
				description:
					"Apple smartphone with A18 Pro chip, 48MP camera, and titanium frame.",
				price: 1299,
				category: "Phones",
				brand: "Apple",
				stock: 20,
			...
			},
			{
				...
				description:
					"Samsung flagship smartphone with Snapdragon 8 Gen 4 and built-in S Pen.",
				price: 1199,
				category: "Phones",
				brand: "Samsung",
				stock: 15,
			...
			},
			{
				name: "MacBook Pro 16",
				description:
					"Apple M3 Max laptop with 36GB Unified Memory and Liquid Retina XDR display.",
				price: 2499,
				category: "Laptops",
				brand: "Apple",
				stock: 10,
			...
			},
			{
				name: "Dell XPS 15",
				description:
					"High performance Intel i9 laptop with 4K OLED display for creators.",
				price: 1899,
				category: "Laptops",
				brand: "Dell",
				stock: 8,
			...
			},
			{
				...
				description:
					"Industry leading wireless noise canceling headphones with crystal clear calls.",
				price: 399,
				category: "Audio",
				brand: "Sony",
				stock: 30,
			...
			},
			{
				name: "iPad Air M2",
				description:
					"Thin and light tablet powered by the Apple M2 chip with 10.9-inch Liquid Retina display.",
				price: 599,
				category: "Tablets",
				brand: "Apple",
				stock: 25,
			...
			},
			{
				...
				description:
					"Premium Android tablet with Dynamic AMOLED 2X display and IP68 rating.",
				price: 799,
				category: "Tablets",
				brand: "Samsung",
				stock: 12,
			...
			},
			{
				...
				description:
					"The ultimate sports and adventure watch with precision dual-frequency GPS.",
				price: 799,
				category: "Wearables",
				brand: "Apple",
				stock: 18,
			...
			},
			{
				...
				description:
					"Ergonomic performance wireless mouse with 8K DPI tracking and quiet clicks.",
				price: 99,
			...
			},
			{
				...
				description:
					"Custom mechanical keyboard with QMK/VIA support and wireless Bluetooth.",
				price: 199,
				category: "Accessories",
				brand: "Keychron",
				stock: 22,
			...
			},
			{
				...
				description:
					"4K QD-OLED 240Hz gaming monitor with ultra-fast response time.",
				price: 1299,
				category: "Monitors",
				brand: "Asus",
				stock: 5,
